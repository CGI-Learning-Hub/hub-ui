...
const meta: Meta<typeof Typography> = {
  title: "Themes/CRNO/Typography",
  component: Typography,
  decorators: [
    (Story, { args }) => (
      <ThemeProvider theme={crnoMuiTheme}>
        <Story />
